...
namespace Backend.Linq2DbIdentity
{
    ...
    {
        /// <summary>
        ///     Constructs a new instance of <see cref="UserStore{TConnection,TUser,TRole}" />.
        /// </summary>
        /// <param name="factory">
        ///     <see cref="IConnectionFactory" />
        /// </param>
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// <returns></returns>
        protected override IdentityUserToken<TKey> CreateUserToken(TUser user,
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        ///     <see
        ///         cref="UserStore{TUser,TRole,TKey,TUserClaim,TUserRole,TUserLogin,TUserToken}" />
        ///     .
        /// </summary>
        /// <param name="factory">
        ///     <see cref="IConnectionFactory" />
        ...
        public async Task SetTokenAsync(TUser user,
            string loginProvider,
            string name,
            string value,
        ...
        protected virtual async Task SetTokenAsync(DataConnection db,
            TUser user,
            string loginProvider,
            string name,
            string value,
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task RemoveTokenAsync(TUser user,
            string loginProvider,
            string name,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task RemoveTokenAsync(DataConnection db,
            TUser user,
            string loginProvider,
            string name,
            CancellationToken cancellationToken)
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task<string> GetTokenAsync(TUser user,
            string loginProvider,
            string name,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<string> GetTokenAsync(DataConnection db,
            TUser user,
            string loginProvider,
            string name,
            CancellationToken cancellationToken)
        ...
        protected virtual async Task<IList<Claim>> GetClaimsAsync(DataConnection db,
            TUser user,
            CancellationToken cancellationToken)
        {
            return await
        ...
        protected virtual Task AddClaimsAsync(DataConnection dc,
            IEnumerable<TUserClaim> data,
            CancellationToken cancellationToken)
        {
            dc.BulkCopy(data);
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task ReplaceClaimAsync(TUser user,
            Claim claim,
            Claim newClaim,
            CancellationToken cancellationToken = default)
        {
        ...
        protected virtual async Task ReplaceClaimAsync(TUser user,
            Claim claim,
            Claim newClaim,
            CancellationToken cancellationToken,
            DataConnection db)
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task RemoveClaimsAsync(TUser user,
            IEnumerable<Claim> claims,
            CancellationToken cancellationToken = default)
        {
            ThrowIfDisposed();
        ...
        protected virtual async Task RemoveClaimsAsync(DataConnection db,
            TUser user,
            IEnumerable<Claim> claims,
            CancellationToken cancellationToken)
        {
            await Task.Run(() =>
                {
                    ...
                    foreach (var claim in claims)
                    {
                        ...
                        var predicatePart = Expression.And(Expression.And(userIdEquals, claimValueEquals),
                            claimTypeEquals);
        ...
        protected virtual async Task<IList<TUser>> UsersForClaimAsync(DataConnection db,
            Claim claim,
            CancellationToken cancellationToken)
        {
        ...
        public virtual Task SetEmailConfirmedAsync(TUser user,
            bool confirmed,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The task object representing the asynchronous operation.</returns>
        public virtual Task SetEmailAsync(TUser user,
            string email,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The task object representing the asynchronous operation.</returns>
        public virtual Task SetNormalizedEmailAsync(TUser user,
        ...
        protected virtual async Task<TUser> FindByEmailAsync(DataConnection db,
            string normalizedEmail,
            CancellationToken cancellationToken)
        {
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetLockoutEndDateAsync(TUser user,
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetLockoutEnabledAsync(TUser user,
            bool enabled,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetUserNameAsync(TUser user,
            string userName,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetNormalizedUserNameAsync(TUser user,
        ...
        protected virtual async Task<IdentityResult> CreateAsync(DataConnection db,
            TUser user,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<IdentityResult> UpdateAsync(DataConnection db,
            TUser user,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<IdentityResult> DeleteAsync(DataConnection db,
            TUser user,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<TUser> FindByIdAsync(DataConnection db,
            TKey id,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<TUser> FindByNameAsync(DataConnection db,
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task AddLoginAsync(TUser user,
            UserLoginInfo login,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        protected virtual async Task AddLoginAsync(DataConnection db,
            TUser user,
            UserLoginInfo login,
            CancellationToken cancellationToken)
        {
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task RemoveLoginAsync(TUser user,
            string loginProvider,
            string providerKey,
            CancellationToken cancellationToken = default)
        {
        ...
        protected virtual async Task RemoveLoginAsync(DataConnection db,
            TUser user,
            string loginProvider,
            string providerKey,
            CancellationToken cancellationToken)
        ...
        protected virtual async Task<IList<UserLoginInfo>> GetLoginsAsync(DataConnection db,
            TUser user,
            CancellationToken cancellationToken)
        {
            var userId = user.Id;
        ...
        /// </returns>
        public async Task<TUser> FindByLoginAsync(string loginProvider,
            string providerKey,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        protected virtual async Task<TUser> FindByLoginAsync(DataConnection db,
            string loginProvider,
            string providerKey,
            CancellationToken cancellationToken)
        {
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetPasswordHashAsync(TUser user,
            string passwordHash,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetPhoneNumberAsync(TUser user,
            string phoneNumber,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetPhoneNumberConfirmedAsync(TUser user,
            bool confirmed,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task AddToRoleAsync(TUser user,
        ...
        protected virtual async Task AddToRoleAsync(DataConnection db,
            TUser user,
            string normalizedRoleName,
            CancellationToken cancellationToken)
        {
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public async Task RemoveFromRoleAsync(TUser user,
            string normalizedRoleName,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        protected virtual async Task RemoveFromRoleAsync(DataConnection db,
            TUser user,
            string normalizedRoleName,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<IList<string>> GetRolesAsync(DataConnection db,
            TUser user,
            CancellationToken cancellationToken)
        {
            var userId = user.Id;
        ...
        /// </returns>
        public async Task<bool> IsInRoleAsync(TUser user,
            string normalizedRoleName,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        protected virtual async Task<bool> IsInRoleAsync(DataConnection db,
            TUser user,
            string normalizedRoleName,
            CancellationToken cancellationToken)
        {
        ...
        protected virtual async Task<IList<TUser>> GetUsersInRoleAsync(DataConnection db,
            string normalizedRoleName,
            CancellationToken cancellationToken)
        {
            var query = from userrole in db.GetTable<TUserRole>()
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetSecurityStampAsync(TUser user,
            string stamp,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        /// </param>
        /// <returns>The <see cref="Task" /> that represents the asynchronous operation.</returns>
        public virtual Task SetTwoFactorEnabledAsync(TUser user,
            bool enabled,
            CancellationToken cancellationToken = default)
        {
            cancellationToken.ThrowIfCancellationRequested();
